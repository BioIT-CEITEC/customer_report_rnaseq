...
plotly.picard.metric <- ggplotly(plot.picard.metric) %>% layout(legend = list(orientation = 'h', y=-0.3))
...
plotly.rseqc.metric <- ggplotly(plot.reseqc.metric) %>% layout(legend = list(orientation = 'h', y=-0.3))
