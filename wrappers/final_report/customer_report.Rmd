...
if(rseqc.intron$intron >= 40){
  ...
  intron.count <- "quite high"
}else if(rseqc.intron$intron >= 5 & rseqc.intron$intron < 20){
  intron.count <- "low"
}else if(rseqc.intron$intron < 5){
  intron.count <- "very low"
}

if(rseqc.mrna$mrna >= 40){
  coding.count <- "high"
}else if(rseqc.mrna$mrna >= 20 & rseqc.mrna$mrna < 40){
  coding.count <- "quite high"
}else if(rseqc.mrna$mrna >= 5 & rseqc.mrna$mrna < 20){
  coding.count <- "low"
}else if(rseqc.mrna$mrna < 5){
