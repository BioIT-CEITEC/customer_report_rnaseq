...
## Analysis
- Raw reads were quality checked (**FastQC, MultiQC, minion, swan**), preprocessed (**Cutadapt, FastQC, MultiQC**) and mapped (**STAR, Samtools, MultiQC**) to the reference genome with gene annotation (**genome version: `r release`**).
...
- The `r paired` reads were aligned to `r species` reference genome with the help of the gene annotation (`r release`) using STAR aligner.
...
### IGV
- Reference genomes and annotations for `r release` are available to download on [Ensembl](https://www.ensembl.org/index.html) website.
