...
tabl_sample <- tabl_sample[,input_reads:=r_processed]
...
fit_to_width(autofit(qflextable(tabl_sample[, .(Sample, condition, "raw reads" = r_processed, "preprocessed reads" = r_written)])),max_width = 9.1)
```
