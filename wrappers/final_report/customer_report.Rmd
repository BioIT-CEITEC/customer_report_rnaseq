...
`r if(config_json$RSEM[1] == TRUE){paste0("  - Read assignment rates are summarized in Table \\@ref(tab:rsem-assign-tab) and Figure \\@ref(fig:plotly-rsem-assign-count).")}`
...
`r if(config_json$salmon_align[1] == TRUE){paste0("  - Read assignment from Salmon in alignment mode are summarized in Table \\@ref(tab:salmonA-assign-tab) and Figure \\@ref(fig:plotly-salmonA-assign-count).")}`
...
`r if(config_json$salmon_map[1] == TRUE){paste0("  - Read assignment from Salmon in mapping mode are summarized in Table \\@ref(tab:salmonM-assign-tab) and Figure \\@ref(fig:plotly-salmonM-assign-count).")}`
...
`r if(config_json$kallisto[1] == TRUE){paste0("  - Read assignment from Kallisto are summarized in Table \\@ref(tab:kallisto-assign-tab) and Figure \\@ref(fig:plotly-kallisto-assign-count).")}`
