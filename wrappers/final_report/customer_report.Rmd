...
pca_heatmap.plot<-function(analysis_type = analysis_type, DE = DE){
  ...
  for(j in 1:length(DE)){
    output<-c(output,cat("#### ",analysis_type[j],"\n"))
    if (file.exists(paste0("../results/",DE[j],"/all_condition_results/report_data/sample_to_sample_PCA.svg"))) {
      all_pca <- ifelse(file.exists(paste0("../results/",DE[j],"/all_condition_results/report_data/sample_to_sample_PCA_batch.svg")), paste0("../results/",DE[j],"/all_condition_results/report_data/sample_to_sample_PCA_batch.svg"), paste0("../results/",DE[j],"/all_condition_results/report_data/sample_to_sample_PCA.svg"))
      all_heatmap <- ifelse(file.exists(paste0("../results/",DE[j],"/all_condition_results/report_data/heatmaps_samples_log_batch.svg")), paste0("../results/",DE[j],"/all_condition_results/report_data/heatmaps_samples_log_batch.svg"), paste0("../results/",DE[j],"/all_condition_results/report_data/heatmaps_samples_log2.svg"))
