...
if(config_json$display_biotypes_RNA[1] == TRUE){
  ...
  mean.pct$Geneid <- factor(mean.pct$Geneid, levels=mean.pct$Geneid[order(-mean.pct$Mean)], ordered=TRUE)
...
`r if(config_json$display_biotypes_RNA[1] == TRUE){"- All the samples captured mainly protein-coding genes (Figure \@ref(fig:biotype))."}`
